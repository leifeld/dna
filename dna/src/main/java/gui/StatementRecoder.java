...
public class StatementRecoder extends JDialog {
	...
	public StatementRecoder(Frame parent, int[] statementIds, StatementType statementType) {
		...
		ArrayList<Statement> statements = Dna.sql.getStatements(statementIds, null, null, null, null, false, null, false, null, false, null, false);
		...
		tableModel = new StatementRecodeTableModel(Dna.sql.getStatements(statementIds, null, null, null, null, false, null, false, null, false, null, false), statementsBackup, statementType);
