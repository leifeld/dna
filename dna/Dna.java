 ...
 * 
 * change log:
 * - improved: more flexible recode window
 * - bugfix: throw Java heap space error if memory is low
 * - bugfix: graphical error in exclude lists during export
 * - new feature: progress monitor when opening and saving files
 * - bugfix: edge weights were not always exported in DL edgelist files; DL edgelist format has been removed
 * - new feature: regex function
 * 
		...
		menu1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					System.out.println("Out of memory. Statement has not been inserted. Please restart Java\nwith the -Xmx1024M option, where '1024' is the space you want\nto allocate to DNA. The manual provides further details.");
