 ...
 * - corrupt end positions are automatically corrected
 * - 'show only current article' now works if there are brackets or other symbols in the article title which are matched by the regex
 * - recode component
 * - 'include isolates' option for the co-occurrence export algorithm
 * 
