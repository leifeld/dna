...
public class DnaAbout extends JFrame {
    ...
    public DnaAbout() {
        ...
        this.setPreferredSize(new Dimension(470,440));
        this.pack();
        this.setLocationRelativeTo(null);
        this.setVisible(true);
        
        Icon dnaTextIcon = new ImageIcon(getClass().getResource(
            "/icons/dna32text.png"));
        ...
        aboutText.setText("<p>Current version: 1.08 (2 August 2009)</p>"
            ...
            + "for a simple graph based on co-occurrences). Then click on export.");
        aboutText.setEditable(false);
        aboutScrollLeiste = new JScrollPane(aboutText);
        aboutScrollLeiste.setPreferredSize(new Dimension(470, 470));
