...
> download.file("upload/Downloads/dna-1.28.jar", destfile="dna-1.28.jar", mode="wb")
> download.file("upload/Downloads/sample.dna", destfile="sample.dna", mode="wb")
> dna.init("dna-1.28.jar")  #connect R to DNA
...
\begin{itemize}
 ...
 \item Bugfix: The dna.gui() method was fixed because many DNA features did not work when DNA was started from within R.
