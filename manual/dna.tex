...
\author{Philip Leifeld\footnote{Address for correspondence: \medskip \newline University of Konstanz \newline Department of Politics and Public Administration \newline Box D\,81 \newline 78457 Konstanz \newline Germany \medskip \newline \href{mailto:philip.leifeld@uni-konstanz.de}{\texttt{philip.leifeld@uni-konstanz.de}} \newline \url{http://www.philipleifeld.de}}}
\title{\includegraphics[width=2cm]{dna32.pdf}\\ \vspace{0.5cm} Discourse Network Analyzer \\ \vspace{0.3cm} \textbf{Manual}}
\date{version 1.29 (\today)}
...
\section*{DNA 1.29 -- 16 October 2011}
\begin{itemize}
  \item Bugfix: Running \code{dna.network()} and related rDNA methods multiple times is now possible. There was a memory/garbage collection problem.
  \item Bugfix: The \code{include isolates} option was broken, causing multiple problems in DNA (e.\,g. with graphML export) and rDNA (``index out of bounds'' exception).
\end{itemize}

\section*{DNA 1.28 -- 11 September 2011}
\begin{itemize}
 \item Improved: Statement frequencies of actors are now exported as attributes to graphML files.
 \item Bugfix: The graphML export was broken whenever the name of at least one actor contained an apostrophe.
 \item Bugfix: When time series statistics were exported, the number of actors was erroneously printed to the command line.
 \item Bugfix: The \code{dna.gui()} method was fixed because many DNA features did not work when DNA was started from within R.
 \item Bugfix: The lambda attenuation parameter was erroneously fixed at a value of 0.1.
\end{itemize}
