	...
	public Recode() {
		...
		okButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (dialog == 0) {
					for (int i = dna.Dna.mainProgram.dc.sc.size() - 1; i >= 0; i--) {
						if ((persCB.isSelected() && persCombo.getSelectedItem().equals(dna.Dna.mainProgram.dc.sc.get(i).getPerson()) && orgCB.isSelected() == false && catCB.isSelected() == false) // 1 0 0
								|| (persCB.isSelected() == false && orgCombo.getSelectedItem().equals(dna.Dna.mainProgram.dc.sc.get(i).getOrganization()) && orgCB.isSelected() == true && catCB.isSelected() == false) // 0 1 0
								|| (persCB.isSelected() == false && catCombo.getSelectedItem().equals(dna.Dna.mainProgram.dc.sc.get(i).getCategory()) && orgCB.isSelected() == false && catCB.isSelected() == true) // 0 0 1
								|| (persCB.isSelected() == true && orgCB.isSelected() == true && catCB.isSelected() == true && persCombo.getSelectedItem().equals(dna.Dna.mainProgram.dc.sc.get(i).getPerson()) && orgCombo.getSelectedItem().equals(dna.Dna.mainProgram.dc.sc.get(i).getOrganization()) && catCombo.getSelectedItem().equals(dna.Dna.mainProgram.dc.sc.get(i).getCategory())) // 1 1 1
								|| (persCB.isSelected() == true && orgCB.isSelected() == true && catCB.isSelected() == false && persCombo.getSelectedItem().equals(dna.Dna.mainProgram.dc.sc.get(i).getPerson()) && orgCombo.getSelectedItem().equals(dna.Dna.mainProgram.dc.sc.get(i).getOrganization())) // 1 1 0
								|| (persCB.isSelected() == true && orgCB.isSelected() == false && catCB.isSelected() == true && persCombo.getSelectedItem().equals(dna.Dna.mainProgram.dc.sc.get(i).getPerson()) && catCombo.getSelectedItem().equals(dna.Dna.mainProgram.dc.sc.get(i).getCategory())) // 1 0 1
								|| (persCB.isSelected() == false && orgCB.isSelected() == true && catCB.isSelected() == true && orgCombo.getSelectedItem().equals(dna.Dna.mainProgram.dc.sc.get(i).getOrganization()) && catCombo.getSelectedItem().equals(dna.Dna.mainProgram.dc.sc.get(i).getCategory())) // 0 1 1
								) {
							if (removeRadio.isSelected()) {
								dna.Dna.mainProgram.dc.sc.removeStatement(dna.Dna.mainProgram.dc.sc.get(i).getId());
								counter++;
							} else if (changeRadio.isSelected()) {
								String persOld = dna.Dna.mainProgram.dc.sc.get(i).getPerson();
								String orgOld = dna.Dna.mainProgram.dc.sc.get(i).getOrganization();
								String catOld = dna.Dna.mainProgram.dc.sc.get(i).getCategory();
								...
								dna.Dna.mainProgram.dc.sc.get(i).setPerson(persNew);
								...
								dna.Dna.mainProgram.dc.sc.get(i).setOrganization(orgNew);
								...
								dna.Dna.mainProgram.dc.sc.get(i).setCategory(catNew);
								counter++;
							}
						}
					}
				...
				String message = "";
				if (counter == 1) {
					message = counter + " statement was " + operation + "d.";
				} else {
					message = counter + " statements were " + operation + "d.";
				}
				JOptionPane.showMessageDialog(Recode.this, message);
			}
		});
