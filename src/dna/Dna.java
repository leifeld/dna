 ...
 * 
 * done:
 * - Bugfix: New article window was not scrollable.
 * - Improved: Search field within articles listens to enter key presses
 * - Bugfix: Exporting actor attributes caused an exception when there were actors without an associated actor type.
 * - New feature: R bindings via the new R package rDNA
 * - Improved: Labels are put in quotation marks in CSV files
 ...
 * - Bug: Export zu graphML führt zu einer Exception, wenn es keine Attribute gibt.
