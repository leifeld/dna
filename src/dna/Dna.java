 ...
 * 
 * done:
 * - Bugfix: Recode function caused an exception when either the person, organization or category list was empty.
 * - Improved: Statistics component was rewritten to make it compatible with rDNA.
 * 
 * to do:
