 ...
 * 
 * done:
 * - Bugfix: Some statements could not be removed.
 * - Bugfix: When removing an actor from the actor manager, selecting a type for the previous actor caused a warning.
 * - Bugfix: When opening another file, the regexes will be removed from the regex highlighter.
 ...
 * @version 1.22 - 17 September 2010
 */
public class Dna extends JFrame {
	...
	class DocStats extends JPanel {
		...
		public void computeStats() {
			int numArticles = ac.getRowCount();
			int numStatements = sc.getRowCount();
			updateLists();
