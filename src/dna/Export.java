...
public class Export {
	...
	public Export(
		...
		if (excludePersons[0].equals("") && excludePersons[1].equals("") && excludePersons.length == 2) {
			excludePersons = new String[0];
		}
		if (excludeOrganizations[0].equals("") && excludeOrganizations[1].equals("") && excludeOrganizations.length == 2) {
			excludeOrganizations = new String[0];
		}
		if (excludeCategories[0].equals("") && excludeCategories[1].equals("") && excludeCategories.length == 2) {
		...
		dc = new ParseLatest(infile).getDc();
		this.sc = dc.sc;
	...
	public String[] getMatrixLabels(boolean row) {
		...
		System.out.println("Creating " + s + " labels... ");
		String[] rowLabels;
		String[] colLabels;
		if (!algorithm.equals("affiliation")) {
			if (includeIsolates == true) {
