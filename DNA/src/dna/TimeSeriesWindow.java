	...
	public class IncludePanel extends JPanel {
		...
		public String[] getIncludedPersons() {
			...
			for (int i = 0; i < personModel.size(); i++) {
				if (person.isSelectedIndex(i)) {
					p.add((String) personModel.getElementAt(i));
				}
			}
			String[] persons = new String[p.size()];
		...
		public String[] getIncludedOrganizations() {
			...
			for (int i = 0; i < organizationModel.size(); i++) {
				if (organization.isSelectedIndex(i)) {
					o.add((String) organizationModel.getElementAt(i));
				}
			}
			String[] organizations = new String[o.size()];
			for (int i = 0; i < o.size(); i++) {
				organizations[i] = o.get(i);
			}
		...
		public String[] getIncludedCategories() {
			...
			for (int i = 0; i < categoryModel.size(); i++) {
				if (category.isSelectedIndex(i)) {
					c.add((String) categoryModel.getElementAt(i));
				}
			}
