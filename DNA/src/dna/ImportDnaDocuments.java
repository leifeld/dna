...
public class ImportDnaDocuments extends JFrame {
		...
		public void run() {
			...
			for (int k = 0; k < aitm.getRowCount(); k++) {
				...
				if ((Boolean)aitm.getValueAt(k, 0) == true) {
					...
					// TODO: check if statement types exist and if they are identical
					// TODO: extract documents from remote DB and insert into local DB
	...
	public void parseArticles(String filename) {
		...
		// TODO: extract documents from remote DB and insert into table
	...
	// TODO: extend table with fields for coder etc.
