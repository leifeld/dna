...
public class GuiCoder extends JFrame implements LogListener, SqlListener {
	 ...
	 */
	private class StatusBar extends JPanel implements StatementListener {
		 ...
		 */
		public StatusBar() {
			documentPanel.addStatementListener(this);
