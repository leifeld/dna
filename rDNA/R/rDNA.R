...
#'
#' Plot a barplot generated from \link{dna_barplot}.
#'
#' This function plots \code{dna_barplot} objects generated by the 
#' \link{dna_barplot} function. It plots agreement and disagreement towards DNA 
#' statements for different entities such as, e.g., \code{"concept"}, 
...
#' @param colors If \code{TRUE}, the Colors column in the \code{dna_barplot} 
#'   object will be used to fill the bars.
...
autoplot.dna_barplot <- function(object, 
  ...
  if (colors & !("Color" %in% colnames(object))) {
    colors <- FALSE
